...
set project_name "homework3_lock_controller"
...
set_property top lock_controller  [get_filesets sources_1]
set_property top tb_lock_controller  [get_filesets sim_1]
